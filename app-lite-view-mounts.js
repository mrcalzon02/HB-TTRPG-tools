(() => {
  ...
  function ensureScientificToolsView() {
    ...
    if (menuGrid && !menuGrid.querySelector('[data-scientific-tools-card="true"]')) {
      ...
      copy.textContent = 'Setting-neutral experimental systems, including the shared Binary Cube Laboratory, Encoder Visualizer, Decryption Dashboard, Information & Deobfuscation Analysis Suite, Communication Capacity Analyzer, ISM Media Simulation, and quantum experiment tools.';
      const button = document.createElement('button');
