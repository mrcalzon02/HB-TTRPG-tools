(() => {
  ...
  async function prepareView(viewId) {
    ...
    if (viewId === 'scientific-tools') {
      ...
      scientificToolsEntryPromise ||= loadScript('scientific-tools-entry.js?v=20260809-key-profile-visualizer-1');
