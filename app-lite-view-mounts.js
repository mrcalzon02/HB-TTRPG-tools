(() => {
  ...
  async function prepareView(viewId) {
    ...
    if (viewId === 'scientific-tools') {
      ...
      scientificToolsEntryPromise ||= loadScript('scientific-tools-entry.js?v=20260809-diagnostic-calibration-1');
    ...
    if (viewId === 'warhammer-40k') {
      ...
      warhammerWorkspacePromise ||= loadScript('warhammer-40k-workspace-v8.js?v=28');
