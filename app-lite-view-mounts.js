(() => {
  ...
  async function prepareView(viewId) {
    ...
    if (viewId === 'utilities') {
      ...
      tabletopToolkitPromise ||= loadScript('tabletop-toolkit.js?v=20260924-dice-textures-2');
    ...
    if (viewId === 'shadowrun') {
      shadowrunEntryPromise ||= loadScript('shadowrun-entry.js?v=20260809-v17-contextual-help');
    ...
    if (viewId === 'warhammer-40k') {
      ...
      warhammerDramatisPromise ||= warhammerChronologyPromise.then(() => loadScript('assets/warhammer-40k/imperial-dramatis-personae-v1.js?v=11'));
      ...
      warhammerWorkspacePromise ||= loadScript('warhammer-40k-workspace-v8.js?v=37');
