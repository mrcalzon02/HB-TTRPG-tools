(() => {
  ...
  const runtimeParts = [
    ...
    'data/barotrauma/tools/runtime/barotrauma-rpg-tools.part-06-world-depth-guarantee.txt',
    ...
    'data/barotrauma/tools/runtime/barotrauma-rpg-tools.part-06-dashboard-management-auth-prelude.txt',
    ...
    'data/barotrauma/tools/runtime/barotrauma-rpg-tools.part-06-dashboard-management-auth-bootstrap.txt',
