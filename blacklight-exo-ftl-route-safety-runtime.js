(() => {
  ...
  async function resolvePhysicalPathSafety({context,rating,registry,route,routeId,family,path,calibration}){
    ...
    const segmentSafety=await FamilySegments.resolveFTLFamilySegmentCertification({
      ...
      topologyHazardKey:context.topologyHazardKey||null,
      topologyHazardApplicabilityResolution:context.topologyHazardApplicabilityResolution||null,
      ...
      topologyApplicabilitySimulationOverride:context.topologyApplicabilitySimulationOverride||null,
