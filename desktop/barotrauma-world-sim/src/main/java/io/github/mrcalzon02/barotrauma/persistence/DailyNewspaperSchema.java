...
public final class DailyNewspaperSchema {
    ...
    public static List<String> statements() {
        return List.of(
                "CREATE TABLE daily_newspaper_edition ("
                ...
                "CREATE INDEX daily_newspaper_edition_date_index ON daily_newspaper_edition(world_id,edition_date DESC)",
                "CREATE TABLE daily_newspaper_article ("
                ...
                "CREATE INDEX daily_newspaper_article_edition_index ON daily_newspaper_article(edition_id,article_order,severity DESC,source_tick DESC)",
                "CREATE VIEW daily_newspaper_observation AS "
