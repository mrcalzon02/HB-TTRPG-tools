...
if(forcedInternal.designPhilosophy.classification!=='INTERNAL'||forcedInternal.designPhilosophy.moduleAssignments.some(module=>module.envelope!=='INTERNAL'))fail('Forced Internals-first routing did not assign every module INTERNAL.');
if(forcedEva.designPhilosophy.classification!=='EVA'||forcedEva.designPhilosophy.moduleAssignments.some(module=>module.envelope!=='EVA'))fail('Forced EVA-first routing did not assign every module EVA.');
...
console.log('Validated Internals-first and EVA-first actuary modifiers, forced routing, designation records, immutable inventory floors, hardpoint-parent rules, inherited alien biology, inherited drive mass, deterministic replay, mass balance, and page loader order.');
