...
if (manifest.schemaVersion !== '1.2.0') throw new Error('Unexpected source manifest schema.');
...
const expected = new Map([
  ['chronicles-elemental-realms-swamps-toads-frogs-salamanders',{ pages:21, bytes:333084, sha256:'3fe1b910779a2b799305b52fb7005f72e18392d62198824708f1e6a48e434f0f', receipt:'source-page-references/Chronicles-of-Elemental-Realms-Swamps-Toads-Frogs-and-Salamanders.source.json', receiptSchema:'1.1.0', wikiDestination:'data/elemental-realms/wiki/wiki-index.json', integrationStatus:'dedicated-wiki-creature-reference-pass-1-complete' }],
...
if (elementalIndex.status !== 'creature-reference-pass-1-complete') throw new Error('Elemental Realms creature-reference pass is not marked complete.');
...
console.log('Elemental Realms is assigned to its dedicated wiki; Solanum Umbra remains staged separately.');
