...
if (!globalWorkflow.includes('immutable regional and system-site packages')) throw new Error('Production workflow does not identify its immutable regional and system-site transaction.');
...
if (receipt.regionalThemeGeneration?.version !== '3.2.0') throw new Error('Receipt does not record regional theme version 3.2.0.');
...
for (const governedPath of [
  receipt.spatialStageLoader, receipt.lightweightMapCore, receipt.spatialConfigCompatibility,
  receipt.systemSiteCatalog, receipt.detailDiversityCore, receipt.regionalThemeExpansion,
  receipt.systemSiteExpansion, receipt.radialLocationLoader, receipt.radialScanCompatibility,
  receipt.worldSeedBridge, receipt.worldScanOverlay, receipt.globalRescanBridge,
  receipt.globalRescanPackageFactory, receipt.globalRescanIngestion, receipt.globalRescanValidator,
  receipt.systemSiteValidator, receipt.contextAwareCore, receipt.contextOutputNormalizer,
  receipt.contextAwareBrowserBridge, receipt.contextAwareServerEnricher,
  receipt.detailDiversityValidator, ...receipt.coreDataFiles
