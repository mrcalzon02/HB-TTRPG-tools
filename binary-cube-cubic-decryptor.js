(() => {
  ...
  const WORKER_URL = 'binary-cube-cubic-decryptor-worker.js?v=20260809-cubic-webgpu-1';
  ...
  function applyPersistedOptions(options = {}) {
    ...
    setValue('#bccd-webgpu-batch-size', options.webgpuBatchSize);
  }
